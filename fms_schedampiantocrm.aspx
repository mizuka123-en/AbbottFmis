<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="fms_schedampiantocrm.aspx.cs" Inherits="stjude.crm.fms_schedampiantocrm" %>
                            ...
                            <div class="row mb-6 trLBLENG border">
                                ...
                                <div class="col-auto tdDATENG">
                                    <div class="form-outline ">
                                        ...
                                        <obout:ComboBox FolderStyle="../styles/plain" CssClass="form-control" runat="server" AppendDataBoundItems="true"
                                ...
                                <div class="col-auto tdDATENG">
                                    <div class="form-outline ">
                                        ...
                                        <obout:ComboBox FolderStyle="../styles/plain" runat="server" AppendDataBoundItems="true"
                                            ID="cmb_citta" Width="250" Height="200" DataSourceID="sdsCitta" DataTextField="descrizione"
                                    ...
                                    <div class="form-outline">
                                        <oajax:CallbackPanel ID="updOspedali" runat="server" RenderMethod="Always">
                                            <Content>
                                                ...
                                                <obout:ComboBox FolderStyle="../styles/plain" runat="server" AppendDataBoundItems="true"
                                                    ID="ddl_ospedale" Width="250" Height="200" DataSourceID="sdsOspedali" DataTextField="descrizione"
                            ...
                            <div class="row mb-6 border trLBLENG">
                                ...
                                <div class="col-auto tdDATENG">
                                    <div class="form-outline">
                                        ...
                                        <obout:ComboBox FolderStyle="../styles/plain" runat="server" AppendDataBoundItems="true"
                                            ID="cmb_cittadest" Width="250" Height="200" DataSourceID="sdsCitta" DataTextField="descrizione"
                                            DataValueField="descrizione" AllowCustomText="false" AllowEdit="false" EnableVirtualScrolling="true"
                                            EmptyText="Selezionare una Citt&agrave;">
                                    ...
                                    <div class="form-outline">
                                        <oajax:CallbackPanel ID="updOspedaliDest" runat="server" RenderMethod="Always">
                                            <Content>
                                                ...
                                                <obout:ComboBox FolderStyle="../styles/plain" runat="server" AppendDataBoundItems="true"
                                                    ID="ddl_ospedaledest" Width="250" Height="200" DataSourceID="sdsOspedaliDest" DataTextField="descrizione"
                                                    DataValueField="idospedale" AllowCustomText="false" AllowEdit="false" EnableVirtualScrolling="true"
                                                    EmptyText="Selezionare un Ospedale">
                                                    <HeaderTemplate>
                                                        <div class="header c1">
                            ...
                            <div class="row mb-8 trLBLENG">
                                ...
                                <div class="col-auto ">
                                    <div class="form-outline mb-auto">
                                        <table style="font-size: 14px; font-weight: bold; padding: 2px; width: 100%"
                                ...
                                <div class="col-auto tdDATENG">
                                    <div class="form-outline">
                                        ...
                                        <obout:ComboBox FolderStyle="../styles/plain" runat="server"
                                            ID="cmb_tipologiaimp" Width="250" AllowCustomText="false" AllowEdit="false" EnableVirtualScrolling="true"
                                ...
                                <div class="col-auto ">
                                    <div class="form-outline">
                                        <input type="button" class="btn" onclick="AggiungiArticolo()" id="btn_aggiungi" runat="server"
                                            value="Aggiungi" />
                                        <input type="button" class="btn btnred" onclick="EliminaArticolo()" id="btn_elimina" runat="server"
